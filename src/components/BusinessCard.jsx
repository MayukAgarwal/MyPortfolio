    ...
    render() {
        return (
	        <section className="business-card-section">
	        	<div className="width-100-percent flex-row flex-center relative cardContainer">
	        		<div className="width-100-percent row cardWrapper">
	        			<div className="col s12 m6 l6 offset-l3 offset-m3 flex-row flex-center cursor-pointer absolute front"  onClick={this.flipCard}>
	        				...
	        				<div className="relative business-card">
	        					<div className="absolute white-text business-card-details flex-column">
	        						...
	        						<div className="flex-row flex-end business-card-icons">
	        							<a href="https://www.linkedin.com/in/mayuk-agarwal/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin white-text"></i></a>
	        						</div>
	        					</div>
	        				</div>
	        			</div>
